...
config.radarr.hostname   = config.radarr.hostname || process.env.SONARR_HOST || 'localhost';
config.radarr.apiKey     = config.radarr.apiKey || process.env.SONARR_APIKEY;
config.radarr.port       = config.radarr.port || process.env.SONARR_PORT || 7878;
config.radarr.urlBase    = config.radarr.urlBase || process.env.SONARR_URLBASE;
config.radarr.ssl        = config.radarr.ssl || process.env.SONARR_SSL || false;
config.radarr.username   = config.radarr.username || process.env.SONARR_USERNAME;
config.radarr.password   = config.radarr.password || process.env.SONARR_PASSWORD;
