...
config.radarr.rootFolder = config.radarr.rootFolder || process.env.DEFAULTS_ROOT_FOLDER;
config.radarr.profileId  = config.radarr.profileId || process.env.DEFAULTS_PROFILE_ID;
config.radarr.monitor    = config.radarr.monitor || process.env.DEFAULTS_MONITOR;
